  ...
  return (
    <section className="py-20 bg-tertiary-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Heading */}
        <h2 className="text-3xl md:text-4xl font-bold text-dark-700 mb-12">
          Our Story
        </h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 lg:p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 pb-12 border-b border-gray-200">
            <div className="space-y-4">
              <h3 className="text-xl lg:text-2xl font-bold text-dark-700">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-36 h-36 mx-auto bg-secondary-100 rounded-lg flex items-center justify-center">
                <FaKey className="w-24 h-24 text-secondary-600" />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 pb-12 border-b border-gray-200">
            <div className="flex justify-center lg:justify-start order-2 lg:order-1">
              <div className="w-36 h-36 mx-auto bg-secondary-100 rounded-lg flex items-center justify-center">
                <FaChartLine className="w-24 h-24 text-secondary-600" />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-36 h-36 mx-auto bg-secondary-100 rounded-lg flex items-center justify-center">
                <FaMousePointer className="w-24 h-24 text-secondary-600" />
              </div>
            </div>
          </div>
