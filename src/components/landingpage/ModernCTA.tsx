...
import phoneMockup from '../../assets/Simple Clean Phone Mockup Season Discount Instagram Post.webp';
    ...
    <section className="bg-primary-500 w-full max-w-7xl mx-auto relative overflow-hidden my-10 rounded-3xl">
      ...
      <div className="modern-container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div 
            ref={rightRef}
            className={`relative flex justify-center lg:justify-center items-center transition-all duration-1000 ease-out delay-300 ${
              rightVisible 
                ? 'opacity-100 translate-x-0' 
                : 'opacity-0 translate-x-8'
            }`}
