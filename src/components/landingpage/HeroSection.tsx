    ...
    <section className="bg-gradient-to-r from-purple-100 via-blue-50 to-green-100 ">
      <div className="modern-container">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center ">
          ...
          <div className="space-y-8 modern-section">
            {/* Main Title */}
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="flex items-center justify-center gap-2 bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors">
              ...
              <button className="flex items-center justify-center gap-2 bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors">
                ...
                <div className="text-left">
                  <div className="font-thin">GET IT ON</div>
          ...
          <div className="relative flex justify-center items-end h-full lg:justify-end ">
