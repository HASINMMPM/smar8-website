      ...
      <div className="bg-dark-800 py-16 rounded-2xl max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center">
          <div className="md:w-2/3 mb-10 md:mb-0 text-center">
            ...
            <a 
              href={buttonUrl}
              className="inline-flex items-center gap-2 mt-12 px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-primary-500 hover:bg-primary-600 md:py-4 md:text-lg md:px-10 transition duration-300 transform hover:scale-105"
            >
              {buttonText}
