import { FaCheck, FaArrowRight, FaArrowLeft, FaEllipsisH, FaUser, FaClock } from 'react-icons/fa';
    ...
    <section className=" relative overflow-hidden">
      <div className="bg-dark-800  pt-16 md:pt-24 mb-16 md:mb-24 rounded-2xl max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          Take control of the leasing process
          </h2>
          
          {/* Sub-headline */}
          <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
          Customize application questions, set your fees, and track every applicant from first inquiry to signed lease—all on smar8. </p>
