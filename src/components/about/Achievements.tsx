...
const Achievements: React.FC = () => {
  return (
    <section className="py-20 bg-teal-800 mb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-teal-200 text-sm font-medium">Our Achievements</span>
          </div>
          ...
          {/* Sub Text */}
          <p className="text-teal-200 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-teal-600 rounded-lg p-8 text-white shadow-lg">
            <div className="text-center">
              <div className="w-16 h-16 bg-white bg-opacity-20 rounded-lg flex items-center justify-center mx-auto mb-6">
                <FaDollarSign className="w-8 h-8 text-teal-600" />
              </div>
          ...
          {/* Card 3: 99.94% Uptime */}
          <div className="bg-teal-900 rounded-lg p-8 text-white shadow-lg">
            <div className="text-center">
              <div className="w-16 h-16 bg-white bg-opacity-20 rounded-lg flex items-center justify-center mx-auto mb-6">
                <FaClock className="w-8 h-8 text-teal-900" />
              </div>
          ...
          <div className="bg-teal-700 rounded-lg p-8 text-gray-900 shadow-lg text-white">
            <div className="text-center">
              <div className="w-16 h-16 bg-white  rounded-lg flex items-center justify-center mx-auto mb-6">
                <FaGlobe className="w-8 h-8 text-teal-700" />
              </div>
          ...
          <div className="bg-teal-900 rounded-lg p-8 text-white shadow-lg">
            <div className="text-center">
              <div className="w-16 h-16 bg-white bg-opacity-20 rounded-lg flex items-center justify-center mx-auto mb-6">
                <FaUsers className="w-8 h-8 text-teal-900" />
              </div>
